...
|팀원|역할|
|------|-----------|
|신승욱| - ERD 설계</br> - Database 구축</br>- 백엔드 및 프론트엔드 개발</br>- 트러블 슈팅 |
|장효준| - ERD 설계</br>- Database 수정 관리</br>- 개발환경 세팅</br>- 백엔드 및 프론트엔드 개발|
|진가영| - 기획안, 발표안 작성</br> - ERD 설계</br> - Database 구축</br> - 백엔드 및 프론트엔드 개발보조|
